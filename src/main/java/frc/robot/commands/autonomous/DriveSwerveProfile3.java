...
public class DriveSwerveProfile3 extends CommandBase implements Runnable {
  ...
  public DriveSwerveProfile3(double[][] waypoints, double[] headings, 
                          double power) {
  ...
  public boolean isFinished() {
    return isNotifierRunning == false;// || currentTime > totalTime;
  }
}